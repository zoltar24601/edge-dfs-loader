// ============================================================
// EDGE DFS - Statcast daily backfill (one-time, chunked)
// Fetches ONE bulk Savant CSV per date (ALL batters at once),
// aggregates per player + pitcher hand + pitch type, and upserts
// into edge_statcast_daily.
//
// Run with a date range (inclusive):
//   START_DATE=2026-06-01 END_DATE=2026-06-30 node scripts/statcast-backfill.js
// Env: SUPABASE_URL, SUPABASE_KEY, START_DATE, END_DATE
//
// Classification rules intentionally mirror hitter-loader.js so the
// rebuilt windows match the legacy loader's numbers.
// ============================================================
...
function aggKey(pid, hand, pt) { return pid + '|' + hand + '|' + pt; }
...
async function main() {
  console.log('EDGE DFS Statcast backfill:', START_DATE, '->', END_DATE);
